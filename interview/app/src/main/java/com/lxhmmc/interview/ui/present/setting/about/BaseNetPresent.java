...
// */
//
//public abstract class BaseNetPresent<T extends BasePresenter> implements T, LoadTaskCallBack<String> {
//
...
//
//
//    //    public AboutPresent(NetTaskModel netTask, AboutContract.NetView addview) {
